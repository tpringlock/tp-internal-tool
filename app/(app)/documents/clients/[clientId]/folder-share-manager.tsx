...
} from "@/app/actions/folder-shares";
...
export interface FolderShareLinkView {
  id: string;
  url: string;
  expires_at: string;
...
function statusOf(link: FolderShareLinkView): Status {
...
export function FolderShareManager({
  ...
  return (
    <div className="space-y-4">
      <p className="text-sm text-slate-500">{t("folderShareHint")}</p>
              ...
              <li key={link.id} className="space-y-2 py-3">
                ...
                {status === "active" && (
                  <div className="flex flex-wrap items-center gap-2">
                    ...
                    <form action={revokeFolderShareLink}>
